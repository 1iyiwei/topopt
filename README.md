...
Making a new load class is fairly simple, make the following steps:
 ...
 2. Copy the [HalfBeam class](https://github.com/AJJLagerweij/topopt/blob/1ef7adf60cc21a4467f51391ff65db5c5831ac3a/src_Compliance/loads.py#L82-L97) to the botom of the file and change the name of the class.
